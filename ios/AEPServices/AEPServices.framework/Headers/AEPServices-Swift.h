...
- (void)onShowFailure SWIFT_DEPRECATED_MSG("Use onError(message:error:) instead. Function onShowFailure will be removed in the next major version of AEPServices.");
@optional
...
///   </li>
///   <li>
///     error - a <code>PresentationError</code> containing the reason why the message was not shown
///   </li>
/// </ul>
- (void)onErrorFullscreenMessage:(AEPFullscreenMessage * _Nonnull)message error:(AEPPresentationError * _Nonnull)error;
@end
...
SWIFT_CLASS_NAMED("PresentationError")
@interface AEPPresentationError : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
