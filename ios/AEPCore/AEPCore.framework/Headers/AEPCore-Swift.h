...
@property (nonatomic, readonly, copy) NSUUID * _Nullable parentID;
...
/// Creates a new <code>Event</code> where the <code>parentID</code> is equal to the <code>id</code> of this <code>Event</code>.
...
/// For direct request -> responses, use <code>createResponseEvent(name:type:source:data:)</code>
/// \param name Name for the <code>Event</code>
///
/// \param type <code>EventType</code> for the <code>Event</code>
///
...
/// \param mask Defines which properties should be used in creation of the Event’s hash
///
- (AEPEvent * _Nonnull)chainedEventWithName:(NSString * _Nonnull)name type:(NSString * _Nonnull)type source:(NSString * _Nonnull)source data:(NSDictionary<NSString *, id> * _Nullable)data mask:(NSArray<NSString *> * _Nullable)mask SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull locationHintResult;)
+ (NSString * _Nonnull)locationHintResult SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull errorResponseContent;)
+ (NSString * _Nonnull)errorResponseContent SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull createTracker;)
+ (NSString * _Nonnull)createTracker SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull trackMedia;)
+ (NSString * _Nonnull)trackMedia SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull contentComplete;)
+ (NSString * _Nonnull)contentComplete SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull edgeMedia;)
+ (NSString * _Nonnull)edgeMedia SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull media;)
+ (NSString * _Nonnull)media SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_NAMED("InitOptions")
@interface AEPInitOptions : NSObject
/// Flag indicating whether Lifecycle tracking is enabled automatically
@property (nonatomic) BOOL lifecycleAutomaticTrackingEnabled;
/// Additional context data for lifecycle tracking passed to <code>MobileCore.lifecycleStart(additionalContextData:)</code>
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable lifecycleAdditionalContextData;
/// App group used to share user defaults and files among containing app and extension apps. Passed to <code>MobleCore.setAppGroup()</code>
@property (nonatomic, copy) NSString * _Nullable appGroup;
/// Returns an instance of <code>InitOptions</code> without the configuration options of either <code>appId</code> or <code>filePath</code>.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Returns an instance of <code>InitOptions</code> with the given <code>appId</code>.
...
/// Returns an instance of <code>InitOptions</code> with the given <code>filePath</code>.
...
/// Initializes the AEP SDK with the specified <code>InitOptions</code>.
/// This automatically registers all boundled extensions and sets up lifecycle tracking.
/// You can disable automatic lifecycle tracking using <code>InitOptions</code>.
/// \param options The <code>InitOptions</code> used to configure the SDK.
///
/// \param completion An optional closure triggered once initialization is complete.
///
+ (void)initializeWithOptions:(AEPInitOptions * _Nonnull)options completion:(void (^ _Nullable)(void))completion SWIFT_AVAILABILITY(tvos_app_extension,unavailable) SWIFT_AVAILABILITY(ios_app_extension,unavailable);
/// Initializes the AEP SDK with all bundled extensions, sets up lifecycle tracking,
/// and configures the SDK using the specified <code>appId</code> via <code>MobileCore.configureWith(appId:)</code>.
/// \param appId A unique identifier assigned to the app instance by Adobe Tags
///
/// \param completion An optional closure triggered once initialization is complete.
///
+ (void)initializeWithAppId:(NSString * _Nonnull)appId completion:(void (^ _Nullable)(void))completion SWIFT_AVAILABILITY(tvos_app_extension,unavailable) SWIFT_AVAILABILITY(ios_app_extension,unavailable);
...
/// Use <code>.infinity</code> to wait indefinitely without <code>EventHub</code> triggering timeout.
///
